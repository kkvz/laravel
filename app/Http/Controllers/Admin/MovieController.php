...
class MovieController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $originalSmallThumbnailName=Str::random(5).$smallThumbnail->getClientOriginalName();
        $originalLargeThumbnailName=Str::random(5).$largeThumbnail->getClientOriginalName();
        ...
        return redirect()->route('admin.movies')->with('sucees', 'Movie created');
    }
