      ...
      <form enctype="multipart/form-data" method="POST" action="{{ route('admin.movie.update', $movie->id) }}">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="trailer" value="{{ $movie->trailer }}" name="trailer" placeholder="Video url">
          </div>
          <div class="form-group">
            <label for="movie">Movie</label>
            <input type="text" class="form-control" id="movie" value="{{ $movie->movie }}" name="movie" placeholder="Video url">
          </div>
          <div class="form-group">
            <label for="duration">Duration</label>
            <input type="text" class="form-control" id="duration" value="{{ $movie->duration }}" name="duration" placeholder="1h 39m">
          </div>
          <div class="form-group">
            <label>Date:</label>
